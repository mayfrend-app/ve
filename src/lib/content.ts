...
export const DEMO_ITEMS: ContentItem[] = [
  ...
  demo("db-2", "banner", "VE Móvil ya disponible",
    "Lleva el lobby contigo: descarga la beta y mira tutoriales donde quieras.",
    "https://github.com/mayfrend-app/ve",
    { image_url: IMG.app, sort_order: 1 }, 28),
  demo("db-3", "banner", "Únete a la comunidad VE",
  ...
  demo("dp-1", "app", "VE Player",
    "El reproductor oficial del lobby: cola automática, atajos de teclado y modo cine.",
    "https://github.com/mayfrend-app/ve",
  ...
  demo("dc-1", "codigo", "Bienvenida al Bootcamp",
    ...
    "", { code_text: "VE-2026-WELCOME", sort_order: 0 }, 16),
  demo("dc-2", "codigo", "Acceso beta a VE Móvil",
    "Canjea este código en la app para desbloquear la beta cerrada.",
    "", { code_text: "VE-BETA-7842", sort_order: 1 }, 14),

  demo("dn-1", "nota", "Cómo funciona el lobby",
